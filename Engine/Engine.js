...
!function (e) {
    if ("object" === typeof exports && "undefined" !== typeof module)
        ...
        var f;
        "undefined" !== typeof window ? f = window : "undefined" !== typeof global ? f = global : "undefined" !== typeof self && (f = self), f.Stage = e();
    }
}(function () {
...
// TODO: replace with atlas fps or texture time
        ...
        }, {"./core": 8, "./loop": 14, "./pin": 16, "./util/create": 22, "./util/math": 26}],
...
// TODO: index textures
        ...
        }, {"./util/await": 21, "./util/extend": 24, "./util/is": 25, "./util/stats": 28}],
        ...
        }, {"./core": 8, "./loop": 14, "./pin": 16, "./util/create": 22, "./util/repeat": 27}],
...
// TODO: move padding to pin
        ...
        }, {"./core": 8, "./loop": 14, "./pin": 16, "./util/create": 22}],
...
// TODO: static/fixed viewbox
        ...
        }, {"./core": 8, "./loop": 14, "./pin": 16, "./util/create": 22, "./util/extend": 24, "./util/stats": 28}],
        ...
        }, {"./core": 8, "./loop": 14, "./pin": 16, "./util/create": 22, "./util/is": 25}],
